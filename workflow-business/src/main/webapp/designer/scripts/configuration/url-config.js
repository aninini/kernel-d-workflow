...
FLOWABLE.APP_URL = {
    ...
    getAccountUrl: function (token) {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/account?token=' + token;
    },
    ...
    getEditorUsersUrl: function () {
        ...
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/editor-users?token=' + myToken;
    },

    getEditorGroupsUrl: function () {
        // 获取token
        let myToken = localStorage.getItem('myToken');
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/editor-groups?token=' + myToken;
    },
    ...
    getCategoryUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/flowableCategory/list';
    },

    /* PUBLIC URLS */
    //流程模型部署url fengshuonan
    getModelPublicUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/flowableDefinition/deploy';
    }
};
