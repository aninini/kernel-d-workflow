package cn.stylefeng.roses.kernel.workflow.business.modular.option.service.impl;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.stylefeng.roses.kernel.rule.enums.YesOrNotEnum;
import cn.stylefeng.roses.kernel.rule.exception.base.ServiceException;
import cn.stylefeng.roses.kernel.workflow.api.exception.enums.FlowableOptionExceptionEnum;
import cn.stylefeng.roses.kernel.workflow.business.core.utils.BpmTitleUtil;
...
import cn.stylefeng.roses.kernel.workflow.business.modular.option.mapper.FlowableOptionMapper;
...
public class FlowableOptionServiceImpl extends ServiceImpl<FlowableOptionMapper, FlowableOption> implements FlowableOptionService {
    ...
    private FlowableOption queryFlowableOption(FlowableOptionParam flowableOptionParam) {
        FlowableOption flowableOption = this.getById(flowableOptionParam.getOptionId());
