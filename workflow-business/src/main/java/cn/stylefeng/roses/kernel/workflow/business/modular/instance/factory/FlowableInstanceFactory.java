package cn.stylefeng.roses.kernel.workflow.business.modular.instance.factory;
...
public class FlowableInstanceFactory {
    ...
    public static PageResult<FlowableInstanceResult> pageResult(List<HistoricProcessInstance> historicProcessInstanceList,
        ...
        List<FlowableInstanceResult> flowableInstanceResultList = convertToFlowableInstanceResultList(historicProcessInstanceList);
        defaultPage.setRecords(flowableInstanceResultList);
