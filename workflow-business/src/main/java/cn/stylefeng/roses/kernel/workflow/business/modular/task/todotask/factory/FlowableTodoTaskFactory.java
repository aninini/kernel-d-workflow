package cn.stylefeng.roses.kernel.workflow.business.modular.task.todotask.factory;
...
public class FlowableTodoTaskFactory {
     ...
     * @date 2020/4/20 1727
     */
    public static PageResult<FlowableTodoTaskResult> pageResult(List<Task> taskList, Page<FlowableTodoTaskResult> defaultPage) {
        List<FlowableTodoTaskResult> flowableTodoTaskResultList = convertToFlowableTodoTaskResultList(taskList);
        defaultPage.setRecords(flowableTodoTaskResultList);
