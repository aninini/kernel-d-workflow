package cn.stylefeng.roses.kernel.workflow.business.modular.model.factory;
...
public class FlowableModelFactory {
    ...
    public static PageResult<FlowableModelResult> pageResult(List<Model> modelList,
        ...
        List<FlowableModelResult> flowableModelResultList = convertToFlowableModelResultList(modelList);
        defaultPage.setRecords(flowableModelResultList);
