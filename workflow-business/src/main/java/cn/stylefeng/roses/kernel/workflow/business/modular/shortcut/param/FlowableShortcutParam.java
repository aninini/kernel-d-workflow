package cn.stylefeng.roses.kernel.workflow.business.modular.shortcut.param;
...
@Data
public class FlowableShortcutParam extends BaseWorkflowRequest {
     ...
     * 名称
     */
    @NotBlank(message = "名称不能为空，请检查shortcutName参数", groups = {add.class, edit.class})
