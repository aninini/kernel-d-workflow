...
import cn.stylefeng.roses.kernel.workflow.business.modular.task.handletask.service.FlowableStartProcessService;
...
public class FlowableStartProcessServiceImpl implements FlowableStartProcessService {
    ...
    public void start(String processDefinitionId, Map<String, String> variables, String nextAssignee,
        ...
        identityService.setAuthenticatedUserId(Convert.toStr(LoginContext.me().getLoginUser().getUserId()));
        //启动，将启动参数传入表单
